...
def main():
    ...
    parser.add_argument("--pred_path", type=str, default="D:/EmoScanTalk/comparisons/ours/voca/npy")
    parser.add_argument("--gt_path", type=str, default="D:/phd_data/VOCA_training/npy_no_eyes")
    parser.add_argument("--templates_path", type=str, default="D:/phd_data/VOCA_training/templates_no_eyes")
    parser.add_argument("--dataset", type=str, default="vocaset")
    args = parser.parse_args()

    if args.dataset == "vocaset":
        if args.templates_path[-3:]=="pkl":
        ...
        lip_mask = np.load("data/voca/mouth_indices_no_eyes.npy")
        upper_mask = np.load('data/voca/upper_face_no_eyes.npy').tolist()
        nr_vertices = templates["FaceTalk_170725_00137_TA"].shape[0] #3931 #5023  #3931
    ...
    if args.dataset == "BIWI":
        ...
        upper_mask = np.load('data/biwi/upper_indices.npy').tolist()
        lip_mask = np.load('data/biwi/mouth_indices.npy').tolist()
    ...
    if args.dataset == "multiface":
        ...
        upper_mask = np.load('data/multiface/upper_indices.npy').tolist()
        lip_mask = np.load('data/multiface/mouth_indices.npy').tolist()
