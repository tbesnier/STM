...
class DiffusionNetAutoencoder(nn.Module):
    ...
    def forward_latent_njf(self, template,
                mass_template, L_template, evals_template, evecs_template, gradX_template, gradY_template, faces_template, sequence_feats):
        ...
        for k in range(1, sequence_feats.shape[1]):

            feats = sequence_feats[:, k, :, :]
            ...
            pred_seq = torch.vstack([pred_seq, pred])
